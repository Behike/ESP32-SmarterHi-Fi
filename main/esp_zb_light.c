...
static void esp_zb_task(void *pvParameters)
{
    ...
    esp_zb_attribute_list_t *esp_zb_on_off_cluster = esp_zb_on_off_cluster_create(&light_cfg);

    // esp_zb_color_dimmable_light_cfg_t light_cfg = ESP_ZB_DEFAULT_COLOR_DIMMABLE_LIGHT_CONFIG();
    // esp_zb_attribute_list_t *esp_zb_color_dimmable_light_cluster = esp_zb_color_dimmable_light_ep_create(HA_ESP_LIGHT_ENDPOINT, &light_cfg);
    ...
    // esp_zb_cluster_list_add_color_control_cluster(esp_zb_cluster_list, esp_zb_color_dimmable_light_cluster, ESP_ZB_ZCL_CLUSTER_SERVER_ROLE);
